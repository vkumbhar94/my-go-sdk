...
// WithUserName adds the userName to the get user using g e t params
func (o *GetUserUsingGETParams) WithUserName(userName string) *GetUserUsingGETParams {
	o.SetUserName(userName)
	return o
}

// SetUserName adds the userName to the get user using g e t params
func (o *GetUserUsingGETParams) SetUserName(userName string) {
	o.UserName = userName
}
